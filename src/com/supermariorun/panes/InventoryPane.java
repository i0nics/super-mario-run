...
public class InventoryPane extends GraphicsPane implements ActionListener{
	...
	public InventoryPane(mainSMR mainSMR) {
		...
		Mushroom = new GImage(IMG_FOLDER + "Mushroom.png", mainSMR.getWidth()/7, mainSMR.getHeight()/5);
		Flower = new GImage(IMG_FOLDER + "Flower.png",mainSMR.getWidth()/2.5, mainSMR.getHeight()/5);
		Star = new GImage(IMG_FOLDER + "Star.png", mainSMR.getWidth()/1.52, mainSMR.getHeight()/5);
		bubbleTimer.start();
	}
